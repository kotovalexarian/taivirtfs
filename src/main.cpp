...
void on_ioctl(
    ...
    case TAIVIRTFS_COMMAND_INSPECT:
        command_inspect(req, arg, in_buf, in_buf_size, out_buf_size);
        break;
    case TAIVIRTFS_COMMAND_MOUNT:
        command_mount(req, arg, in_buf, in_buf_size, out_buf_size);
        break;
    default:
